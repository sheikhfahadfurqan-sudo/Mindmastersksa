...
export const MOCK_USERS = [
  { id: 'u1', name: 'Tariq Al-Mansoor', email: 'tariq.mansoor@mindmasters.sa', password: 'ExecSecret2026!', role: 'EXECUTIVE', title: 'Chief Executive Officer', department: 'Executive', avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=150&q=80', salarySAR: 120000 },
  { id: 'u2', name: 'Dr. Reem Al-Saud', email: 'reem.alsaud@mindmasters.sa', password: 'ExecSecret2026!', role: 'EXECUTIVE', title: 'VP of Digital Transformation', department: 'Executive', avatar: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=150&q=80', salarySAR: 95000 },
  { id: 'u3', name: 'Sarah Al-Ghamdi', email: 'sarah.ghamdi@mindmasters.sa', password: 'AdminSecret2026!', role: 'ADMIN', title: 'Head of PMO & Enterprise Delivery', department: 'Operations', avatar: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=150&q=80', salarySAR: 48000 },
  { id: 'u4', name: 'Eng. Omar Al-Zahrani', email: 'omar.zahrani@mindmasters.sa', password: 'AdminSecret2026!', role: 'ADMIN', title: 'Lead Systems Architect', department: 'Engineering', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=150&q=80', salarySAR: 42000 },
  { id: 'u5', name: 'Fahad K. Al-Otaibi', email: 'fahad.otaibi@mindmasters.sa', password: 'EmpSecret2026!', role: 'EMPLOYEE', title: 'Senior Full Stack Developer', department: 'Engineering', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=150&q=80', salarySAR: 28000 },
  { id: 'u6', name: 'Noura Al-Dosari', email: 'noura.dosari@mindmasters.sa', password: 'EmpSecret2026!', role: 'EMPLOYEE', title: 'Lead UI/UX Product Designer', department: 'Design', avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=150&q=80', salarySAR: 26000 },
  { id: 'u7', name: 'Youssef Al-Harbi', email: 'youssef.harbi@mindmasters.sa', password: 'EmpSecret2026!', role: 'EMPLOYEE', title: 'DevOps & Cloud Engineer', department: 'Infrastructure', avatar: 'https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?auto=format&fit=crop&w=150&q=80', salarySAR: 25000 },
  { id: 'u8', name: 'Mona Al-Mutairi', email: 'mona.mutairi@mindmasters.sa', password: 'EmpSecret2026!', role: 'EMPLOYEE', title: 'Business Analyst', department: 'Operations', avatar: 'https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?auto=format&fit=crop&w=150&q=80', salarySAR: 22000 }
];
